...
function getUpdatedConversation(
...
function updateCurrentConversation(
	setSelectedConversation: SetConversationAction,
...
function updateStreamingConversation(
	setSelectedConversation: SetConversationAction,
	currentConversation: Conversation,
	text: string
): void {
	...
	currentConversation.messages = preMessages.map((message, index) =>
