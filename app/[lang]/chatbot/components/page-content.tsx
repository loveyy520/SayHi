...
const ChatHome = ({ dictionary }: Props) => {
    // STATE ----------------------------------------------
    ...
    const handleNewConversation = () => {
        ...
        const newConversation: Conversation = {
            id: uuidv4(),
            name: `${dictionary.chat['New Conversation']}`,
            messages: [],
        ...
        >
            ...
            <section className='flex h-full w-full pt-[48px] sm:pt-0'>
                <Chatbar
                    ...
                    onCreateFolder={(name: string) => handleCreateFolder(name, 'chat')}
                ...
                <Promptbar
                    ...
                    onCreateFolder={(name: string) => handleCreateFolder(name, 'prompt')}
                    onDeleteFolder={handleDeleteFolder}
                    onUpdateFolder={handleUpdateFolder}
                />
            </section>
