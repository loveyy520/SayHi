...
export const CodeBlock: FC<Props> = memo(({ dictionary, language, value }) => {
	...
	const downloadAsFile = () => {
		...
		const fileName = window.prompt(
            dictionary.chat['Enter file name'] || '',
			suggestedFileName
		)
			...
			<div className='flex items-center justify-between py-1.5 px-4'>
				...
				<div className='flex items-center'>
					...
					>
                        ...
                        {isCopied ? dictionary.chat['Copied!'] : dictionary.chat['Copy code']}
					</Button>
					<Button
						size='icon'
						variant='ghost'
